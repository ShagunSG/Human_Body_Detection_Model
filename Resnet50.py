...
# Load the model
model = tf.keras.models.load_model(filepath = 'D:\IIT Indore Files\Assignments\Sem-6\Human_Body_Detection_Model\model.h5')

# Predict on a single image
img_path = 'D:\IIT Indore Files\Assignments\Sem-6\Human_Body_Detection_Model\Screenshots\Screenshot_1087.png'
